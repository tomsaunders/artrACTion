function Marker(poiData) {
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(new AR.ImageResource(poiData.img), 8, {
        zOrder: 10,
        opacity: 0.0,
        onClick: null
    });

    this.titleLabel = new AR.Label(poiData.title.trunc(18), 0.8, {
        zOrder: 1,
        offsetY: 0.55,
        style: {
            textColor: '#FFFFFF',
...
Marker.prototype.setSelected = function(marker) {
    ...
    marker.titleLabel.opacity = 0.0;
    marker.descriptionLabel.opacity = 0.0;
...
Marker.prototype.setDeselected = function(marker) {
    ...
    marker.descriptionLabel.opacity = 1.0;
